...
import {PostListComponent, PostListResolverService} from "./post-list/post-list.component";
import {PostCommentsComponent, PostCommentsResolver} from "./post-comments/post-comments.component";
import {ChatListComponent, ChatListResolverService} from "./chat-list/chat-list.component";
...
import {ChatComponent, ChatResolverService} from "./chat/chat.component";
import {OneOneChatComponent} from "./one-one-chat/one-one-chat.component";

const routes: Routes = [
  { path: "", component: PostListComponent, canActivate: [authGuard], resolve: {posts: PostListResolverService} },
  ...
  { path: "messages", component: ChatListComponent, canActivate: [authGuard], resolve: {chats: ChatListResolverService} },
  { path: "chat/create", component: OneOneChatComponent, canActivate: [authGuard] },
  { path: "chat/:chatId", component: ChatComponent, canActivate: [authGuard], resolve: {chatData: ChatResolverService}},
